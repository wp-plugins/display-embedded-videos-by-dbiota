...
It is simple and clean, just works with shortcodes that can be easily created in the plugin *Settings Page* with a *Shortcode Wizard*.
...
* vids displayed get update accordingly to new vids posted in your site
